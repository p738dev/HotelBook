...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Update Book</div>
        <div class="ps-3">
    ...
    <div class="container">
        <div class="main-body">
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <form action="{{ route('book.book.update') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img src="{{ asset($book->image) }}" alt="Book" class="rounded-circle p-1 bg-primary" id="showImage" width="80">
                                    </div>
                                </div>
                                <div class="row">
